...
export class SeoService {
  ...
  setProductStructuredData(product: any): void {
    ...
    const structuredData: any = {
      ...
      "brand": {
        "@type": "Brand",
        "name": product.brand?.name || "FelunorWear"
      },
      "offers": {
        "@type": "Offer",
  ...
  setOrganizationStructuredData(): void {
    const structuredData = {
      ...
      "@type": "Organization",
      "name": "Ecomus",
      "url": "https://FelunorWear.com",
      "logo": "https://FelunorWear.com/assets/images/logo.png",
      "sameAs": [
  ...
  setArticleStructuredData(article: any): void {
    const structuredData = {
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://FelunorWear.com/assets/images/logo.png"
        }
      },
  ...
  updateDefaultSeo(): void {
    ...
    this.setSEOData({
      ...
      description: 'Discover new season shirts jackets suits denim and more at FelunorWear. Premium quality fast shipping across India COD and easy returns.',
      keywords: 'activewear, gym wear, joggers, men\'s clothes, women\'s clothes, stylish outfits, comfort fit, performance clothing, FelunorWear',
      type: 'website',
      url: 'https://FelunorWear.com/'
    });
  }
   ...
   */
  setProductPageSEO(product: any, productSlug: string | null, baseUrl: string = 'https://FelunorWear.com'): void {
  ...
  private generateProductTitle(product: any): string {
    ...
    // Example: "Nike Air Max 270 Men's Running Shoes - ₹8,999 | FelunorWear"
    return `${brand}${product.name}${category} - ${price} | FelunorWear`;
  }
  ...
  private generateProductDescription(product: any): string {
    ...
    let rawDescription: string = product.meta_description
      ...
      || product.description
      || `Shop ${brand}${product.name}${category} online at FelunorWear. Premium quality, great prices, fast delivery.${discount}`;
  ...
  private sanitizeProductDescription(text: string): string {
    ...
    if (!sanitized) {
      sanitized = 'Premium quality, great prices, fast delivery from FelunorWear.';
    }
  ...
  private generateProductKeywords(product: any): string {
    ...
    keywords.push('buy online', 'FelunorWear', 'fashion', 'clothing');
